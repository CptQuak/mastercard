...
from mastercard.models.mc_lgbm.hyperparameters import Hyperparameters
...
def train_pipe(
    ...
    X_train, y_train = X_train.to_pandas(use_pyarrow_extension_array=True), y_train.to_pandas(use_pyarrow_extension_array=True)

    vectorizer = TableVectorizer(n_jobs=2).set_params(
